...
@class SBPasscodeEntryAlertViewController, NSMutableSet, NSHashTable, SBLockScreenViewControllerBase, SBPasscodeLockDisableAssertion;
...
@property(readonly, assign) BOOL isInLostMode;
