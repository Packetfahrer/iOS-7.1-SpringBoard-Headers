...
@class NSDictionary, NSMutableArray, SBAppSliderSettings, SBAppSliderScrollingViewController, NSObject, SBAppSwitcherStatusBarViewCache, SBAppSliderIconController, NSString, SBAppSliderContainer, NSArray, SBAppSwitcherServices, NSMutableDictionary, NSMutableSet, UIView;
