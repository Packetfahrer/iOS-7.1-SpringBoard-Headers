...
@class SBStarkNowPlayingWindow, SBWindow, UIScreen, SBStarkScreenFocusController, NSMutableOrderedSet, SBCarDisplaySettings, SBStarkStatusBarWindow, SBStarkStatusBarViewController, SBStarkIconWindow, SBAssistantWindow, NSHashTable, SBStarkNotificationViewController, AVExternalDevice, SBStarkLockOutViewController, SBStarkNotificationWindow, SBAlertManager, SBStarkLockOutWindow, SBStarkNowPlayingController, SBStarkIconController, SBStarkDefaultHostingWindow, SBStarkFakeIconOperationController, UIWindow, NSMapTable;
