...
@class NSDate, UIImage, NSSet, BBSectionInfo, NSMutableSet, NSString, NSArray, NSMutableArray;
...
@property(readonly, assign) BOOL displaysCriticalBulletins;
@property(retain, nonatomic) UIImage* iconImage;
@property(retain, nonatomic) UIImage* largeIconImage;
@property(readonly, retain) NSDate* lastSortDate;
