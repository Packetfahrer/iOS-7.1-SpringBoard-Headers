...
@class NSMutableDictionary, NSMutableSet, NSString, LSApplicationProxy, NSProgress;
...
@property(readonly, assign) unsigned installType;
@property(readonly, assign, getter=isInstalling) BOOL installing;
@property(readonly, assign) BOOL isNewsstand;
+ (id)backgroundQueue;
