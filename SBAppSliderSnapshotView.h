...
@class SBApplication, NSObject, SBAppSwitcherStatusBarViewCache, SBSnapshotImageInfo, SBAppSliderSettings, UIImageView, SBWallpaperEffectView, SBZoomableCrossfadeView, UIImage, UIView;
