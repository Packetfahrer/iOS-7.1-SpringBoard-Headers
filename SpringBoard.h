...
@class SBApplication, NSMutableArray, SBCardItemsController, NSNumberFormatter, NSDate, NSSet, NSObject, BBDataProviderConnection, SBUIController, UIWindow, NSHashTable, NSMutableSet, NSTimer;
...
@property(readonly, assign) int activeInterfaceOrientation;
@property(readonly, retain) NSMutableArray* appsRegisteredForVolumeEvents;
...
@property(readonly, retain) SBApplication* menuButtonInterceptApp;
@property(readonly, assign) BOOL menuButtonInterceptAppEnabledForever;
@property(readonly, retain) SBApplication* nowPlayingApp;
@property(readonly, retain) SBApplication* nowRecordingApp;
