...
@class SBIconViewMap, AVExternalDevice, NSIndexPath, NSSet, SBStarkFolderController, SBIconModel, SBStarkIconLayoutOverrideStrategy, _UILegibilitySettings, SBStarkFakeIconOperationController, SBIcon;
