...
@class UIWindow, SBWallpaperPreviewSnapshotCache, NSHashTable, NSMutableSet, SBWallpaperEffectView, UIView, SBFWallpaperView;
...
@property(readonly, assign) CGColorRef homescreenLightForegroundBlurColor;
@property(assign, nonatomic) float homescreenWallpaperScale;
@property(assign, nonatomic) float lockscreenWallpaperScale;
@property(readonly, retain) SBWallpaperPreviewSnapshotCache* previewCache;
