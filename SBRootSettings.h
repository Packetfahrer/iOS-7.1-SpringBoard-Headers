...
@class SBHomeButtonSettings, SBAlertItemsSettings, SBRootAnimationSettings, NSString, SBFolderSettings, SBFWallpaperSettings, SBControlCenterSettings, SBFadeAnimationSettings, SBLegibilitySettings, SBNotificationCenterSettings, SBAppParallaxSettings, SBLockScreenSettings, SBAppSliderSettings, SBIconColorSettings, SBLockScreenTestPluginSettings, SBCarDisplaySettings, SBFAnimationFactorySettings;
