...
@class SBFolderControllerAnimationContext, SBIconAnimator, SBIconViewMap, SBFolderView, NSMapTable, SBFolder, _UILegibilitySettings, NSArray, SBFolderContext, NSTimer, SBIcon;
