...
@class SBIconListView, NSMutableArray, SBIconViewMap, SBIconScrollView, SBIconListPageControl, SBFolderTitleTextField, SBFolder, _UILegibilitySettings, NSArray, NSMutableSet, UIView;
