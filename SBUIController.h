...
@class SBApplication, NSMutableArray, SBWorkspaceEventQueueLockAssertion, NSString, SBWindow, SBAppSliderWindowController, SBDismissOnlyAlertItem, SBAppSliderController, SBSwitchAppGestureView, SBAnimationStepper, UIStatusBar, NSArray, NSMutableDictionary, NSMutableSet, UIView;
...
@property(readonly, assign) float batteryCapacity;
@property(readonly, retain) UIView* contentView;
@property(readonly, assign) float curvedBatteryCapacity;
@property(assign) BOOL isConnectedToUnsupportedChargingAccessory;
@property(readonly, assign) BOOL supportsDetailedBatteryCapacity;
@property(readonly, retain) SBAppSliderController* switcherController;
@property(readonly, retain) SBWindow* window;
