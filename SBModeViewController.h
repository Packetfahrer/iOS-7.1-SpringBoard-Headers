...
@class UIView, SBBulletinObserverViewController, SBModeControlManager, NSArray, UIScrollView, UISwipeGestureRecognizer, UIViewController, SBNotificationCenterSeparatorView;
