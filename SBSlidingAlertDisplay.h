...
@class UIView, SBDeviceLockView, SBEmergencyCallView, UIStatusBar, UIImage, UIImageView;
...
@property(readonly, retain) UIView* bottomBar;
@property(readonly, assign) int currentOrientation;
@property(assign, nonatomic) id<SBSlidingAlertDisplayDelegate> delegate;
@property(readonly, retain) SBDeviceLockView* deviceLockView;
@property(assign, getter=isShowingDeviceLock) BOOL showingDeviceLock;
@property(readonly, retain) UIView* topBar;
