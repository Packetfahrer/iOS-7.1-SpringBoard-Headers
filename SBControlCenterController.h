...
@class SBApplication, SBChevronView, NSSet, NSHashTable, SBControlCenterViewController, _UIBackdropView, UIImageView, _UIDynamicValueAnimation, NSMutableSet, UIDynamicAnimator, SBControlCenterWindow, UIView, SBControlCenterRootView;
