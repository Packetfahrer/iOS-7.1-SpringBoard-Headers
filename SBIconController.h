...
@class NSMutableArray, UITouch, NSIndexPath, SBIconModel, NSSet, SBIconContentView, SBIcon, BBObserver, SBFolder, SBIconColorSettings, _UILegibilitySettings, SBLeafIcon, NSMutableSet, SBRootFolderController, NSTimer;
