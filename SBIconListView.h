...
@class UIView, SBIcon, NSMutableArray, SBIconViewMap, SBIconListModel, NSArray, NSMutableSet;
...
@property(retain) SBIcon* bouncedIcon;
...
@property(retain) SBIconListModel* model;
@property(assign, nonatomic) int orientation;
@property(assign, nonatomic) BOOL purged;
@property(readonly, retain) NSMutableArray* removedIcons;
@property(assign, nonatomic) float statusBarHeight;
@property(readonly, retain) SBIconViewMap* viewMap;
