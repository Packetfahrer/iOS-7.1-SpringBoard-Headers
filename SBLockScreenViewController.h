...
@class SBLockScreenFullscreenBulletinViewController, SBLockScreenDateViewController, SBLockScreenCameraController, SBLockScreenNowPlayingPluginController, SBLockScreenPluginController, NSMutableArray, SBLockScreenResetRestoreViewController, MPUSystemMediaControlsViewController, SBLockScreenInfoOverlayViewController, SBLockOverlayContext, SBLockScreenNotificationListController, SBLockScreenHintManager, SBLockScreenBatteryChargingViewController, SBLockScreenTemperatureWarningViewController, SBLockScreenLegalViewController, SBLockScreenBuddyViewController, SBLockScreenEmergencyCallViewController, SBLockScreenSystemAlertFullscreenViewController, SBUnlockActionContext, SBLockScreenDeviceBlockViewController, SBLockScreenModalAlertViewController, SBLockScreenTimerViewController, SBDisableAppStatusBarUserInteractionChangesAssertion;
...
@property(readonly, assign) BOOL wasAutoUnlocked;
