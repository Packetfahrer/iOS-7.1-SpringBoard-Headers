...
@class SBChevronView, NSMutableArray, SBLockOverlayStylePropertiesFactory, _UIBackdropView, SBSlideToUnlockFailureRecognizer, SBLockScreenBounceAnimator, SBLockScreenScrollView, SBLockScreenTimerView, SBFakeStatusBarView, UIScrollView, NSSet, SBLockScreenBatteryChargingView, SBWallpaperEffectView, SBFLockScreenDateView, _UILegibilitySettings, _UIGlintyStringView, SBDisableAppStatusBarAlphaChangesAssertion, NSMutableSet, UIView;
