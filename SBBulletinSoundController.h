...
@class NSMutableDictionary, NSMutableSet, NSMutableArray, BBObserver;
...
@property(readonly, assign) BOOL quietModeEnabled;
@property(readonly, assign) unsigned quietModeState;
